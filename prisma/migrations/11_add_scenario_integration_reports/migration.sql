...
ALTER TABLE "project_integrations"
  ADD COLUMN "reporting_config" JSONB;

CREATE TABLE "scenario_integration_reports" (
...
CREATE UNIQUE INDEX "scenario_integration_reports_scenario_id_provider_key"
  ON "scenario_integration_reports"("scenario_id", "provider");

CREATE INDEX "scenario_integration_reports_project_id_provider_status_idx"
  ON "scenario_integration_reports"("project_id", "provider", "status");

CREATE INDEX "scenario_integration_reports_run_db_id_idx"
  ON "scenario_integration_reports"("run_db_id");

CREATE INDEX "scenario_integration_reports_status_updated_at_idx"
